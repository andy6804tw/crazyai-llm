...
1. 大型語言模型（LLMs）與文字生成的基礎知識
2. 提示工程（Prompt Engineering）技巧與實作
...
- **💻 Kaggle 實作練習**  
  完成以下兩個實作練習，進一步驗收所學：
  - [Prompting Fundamentals](https://www.kaggle.com/code/markishere/day-1-prompting)：練習基本的提示語設計與運用。
  - [Evaluation and Structured Data](https://www.kaggle.com/code/markishere/day-1-evaluation-and-structured-output)：學習如何評估提示語效果及處理結構化數據。
